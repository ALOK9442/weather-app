...
function Weather() {
  ...
  return (
    <div className='overflow-y-hidden mt-8 space-y-4 rounded-md w-full '>
      <div className='items-center flex space-x-6 mt-8 justify-center'>
            ...
            <div className='flex flex-col items-center'>
              ...
              <div className='flex items-center justify-around pt-4 pb-4 w-full'>
                <div className='flex flex-col space-y-1 items-center'>
                  <p className='font-mono items-center flex h-4 w-4 text-xl text-white'>
                    <img src={humidity} />
                    Humidity
                  </p>
                ...
                <div className='flex flex-col items-center p-2 space-y-4'>
                  <p className='font-bold text-xl text-white'>{currentWeather.location.name}</p>
                ...
                <div className='flex items-center p-2 flex-col'>
                  ...
                  <p className='text-lg font-mono text-white'>{currentWeather.current.condition.text}</p>
                </div>
              </div>
              ...
              <div className='flex items-center justify-around pt-4 pb-4 w-full'>
                <div className='flex flex-col space-y-1 items-center'>
                  <p className='font-mono text-2xl text-white'>Feels like</p>
                  <p className='text-mono font-semibold text-white'>
                ...
                <div className='flex flex-col items-center p-2 space-y-4'>
                  <p className='font-semibold text-mono text-2xl text-white'>
                    Clouds
                  </p>
                  <p className='text-md font-medium text-white'>{currentWeather.current.cloud}</p>
                </div>
                <div className='flex items-center p-2 flex-col'>
                  <p className='font-semibold text-mono text-2xl text-white'>Air Quality Index</p>
